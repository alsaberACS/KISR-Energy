...
#overall analysis    
 ...
 'Refrigerator - The estimated Watts consumed per day']]
           ...
           # st.table(data=family)
            ...
            demo['اعلى مؤهل دراسي لرب الأسرة']= demo['اعلى مؤهل دراسي لرب الأسرة'].replace({'ثانوي او مايعادل': 'secondary or equivalent', 'دبلوم': 'diploma', 'جامعي': 'Bachelor', 'ماجستير': 'Master','دكتوراه':'PHD', 'متوسط':'Others','ابتدائي':'Others','الداخليه':'Others','ثانوي':'Others','لا يوجد مؤهل دراسي':'Others','امي':'Others','متوسطه':'Others','متوفي':'Others','الابتدائي':'Others','معلم':'Others'})  
